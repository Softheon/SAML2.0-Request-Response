...
namespace CarrierPortal
{
    public static class TokenHandler
    {
        ...
        public static Dictionary<string, string> Read(string token)
        {
            ...
            var firstName = assertionNode.SelectSingleRequiredNode("//saml:Attribute[@Name='First Name']/saml:AttributeValue", ns);
            var middleName = assertionNode.SelectSingleRequiredNode("//saml:Attribute[@Name='Middle Name']/saml:AttributeValue", ns);
            var lastName = assertionNode.SelectSingleRequiredNode("//saml:Attribute[@Name='Last Name']/saml:AttributeValue", ns);
            var address1 = assertionNode.SelectSingleRequiredNode("//saml:Attribute[@Name='Street Name 1']/saml:AttributeValue", ns);
            var address2 = assertionNode.SelectSingleRequiredNode("//saml:Attribute[@Name='Street Name 2']/saml:AttributeValue", ns);
            var city = assertionNode.SelectSingleRequiredNode("//saml:Attribute[@Name='City']/saml:AttributeValue", ns);
            var state = assertionNode.SelectSingleRequiredNode("//saml:Attribute[@Name='State']/saml:AttributeValue", ns);
            var zip = assertionNode.SelectSingleRequiredNode("//saml:Attribute[@Name='Zip Code']/saml:AttributeValue", ns);
            var email = assertionNode.SelectSingleRequiredNode("//saml:Attribute[@Name='Contact Email Address']/saml:AttributeValue", ns);
            var amountOwed = assertionNode.SelectSingleRequiredNode("//saml:Attribute[@Name='Total Amount Owed']/saml:AttributeValue", ns);
            var redirectUrl = assertionNode.SelectSingleRequiredNode("//saml:Attribute[@Name='Return URL']/saml:AttributeValue", ns);

            return new Dictionary<string, string>()
            {
               {"amountOwed", amountOwed.InnerText},
               {"firstName", firstName.InnerText },
               {"lastName", lastName.InnerText },
               {"address1", address1.InnerText },
               {"address2", address2.InnerText},
               {"middleName", middleName.InnerText},
               {"city", city.InnerText },
